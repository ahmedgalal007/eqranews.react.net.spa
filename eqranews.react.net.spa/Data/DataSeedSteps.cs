    ...
    public class DataSeedSteps
    {
        ...
        public static void Seed(IServiceScope scope)
        {
            ...
            var _emaritesToday = new List<List<string>>{
                new List<string> {"الإمارات اليوم", "أحدث الأخبار", "https://www.emaratalyoum.com/politics", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
                new List<string> {"الإمارات اليوم", "سياسة", "https://www.emaratalyoum.com/politics", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
                new List<string> {"الإمارات اليوم", "رياضة", "https://www.emaratalyoum.com/sports", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
                new List<string> {"الإمارات اليوم", "إقتصاد", "https://www.emaratalyoum.com/business", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
                new List<string> {"الإمارات اليوم", "صحة وجمال", "https://www.emaratalyoum.com/fashion-and-beauty", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
                new List<string> {"الإمارات اليوم", "منوعات", "https://www.emaratalyoum.com/politics/international", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
                new List<string> {"الإمارات اليوم", "تكنولوجيا", "https://www.emaratalyoum.com/technology", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
                new List<string> {"الإمارات اليوم", "تحقيقات", "https://www.emaratalyoum.com/politics/reports-and-translation", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
                new List<string> {"الإمارات اليوم", "فكر وثقافة", "https://www.emaratalyoum.com/life/culture", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
                new List<string> {"الإمارات اليوم", "حوادث", "https://www.emaratalyoum.com/local-section/accidents", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
                new List<string> {"الإمارات اليوم", "فنون", "https://www.emaratalyoum.com/life/cinema", "{\"Container\":\".maincontent ul > li > article\",\"Url\":\".media > a\", \"Thumb\":\".media  img\",\"ImageAttr\":\"data-src\"}", "#mainarea > h1.title", "#mainarea.maincontent figure.detailsmedia img", "#articledetails"},
            };
